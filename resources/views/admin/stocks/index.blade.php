...
@section('content')
    <a href="{{route('stocks.create')}}">
        <button class="btn btn-sm btn-primary">@lang('admins.add') @lang('admins.stocku')</button>
    </a>
