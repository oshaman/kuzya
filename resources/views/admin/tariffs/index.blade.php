...
@section('content')
    <a href="{{route('tariffs.create')}}">
        <button class="btn btn-sm btn-primary">@lang('admins.add_review_tariffs')</button>
    </a>
